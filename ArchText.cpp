...
/* read_file()
 * Le o arquivo e coloca as palavras em um vetor de vetores de string
 */
...
// le o arquivo e o trasnforma em um vetor de strings
...
// auxilia o construtor da Hash a introduzir as informações
...
// auxilia o construtor da trie a introduzir as informações
...
// remove as stopwords nas frases presentes no vetor
void ArchText::remove_stop_words(vector<vector<string> > &vv_s){
    // capta as stopwords ordenadas
...
// verifica se c esta na lista de delins
...
// separa uma string (tokenização) de acordo com o delimitador 
